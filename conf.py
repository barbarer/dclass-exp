...
html_title = 'dclass-exp'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='dclass-exp'
...
course_description = "Duke Univeristy version of an interactive ebook for an ITiCSE working group led by Dr. Barbara Ericson, Dr. Janice Pearce, and Dr. Susan Rodger to test Parsons with and without distractors."
